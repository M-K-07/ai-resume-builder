    ...
    <motion.div
      ...
      <div className="rounded-[22px] px-2 py-2 sm:px-4 sm:py-3 dark:bg-zinc-900">
        ...
        {educationList.map((item, index) => (
          <div key={index}>
            <form className="mt-1 mb-4 sm:mt-1 sm:mb-5 grid grid-cols-1 md:grid-cols-2 text-white gap-3 sm:gap-4 rounded-2xl p-3 sm:p-6 shadow-[0_8px_30px_rgb(0,0,0,0.12)] bg-gradient-to-br from-zinc-800 via-zinc-900 to-black ring-1 ring-zinc-700/50 hover:ring-zinc-500/80 transition duration-300 ease-in-out w-full">
              <div>
