    ...
    <motion.div
      ...
      <div className="rounded-[22px] px-4 py-3  dark:bg-zinc-900">
        <div className="flex justify-between">
          <h1 className="text-2xl my-3">Summary</h1>
        ...
        >
          ...
          <div className="my-2 col-span-2 ">
            <textarea
              ...
              className="w-full text-sm p-4 rounded-xl min-h-[30vh] bg-transparent text-zinc-200 placeholder:text-zinc-500 border border-zinc-600 transition-all duration-300 ease-in-out"
            />
          </div>
