    ...
    <motion.div
      ...
      <div className="rounded-[22px] px-2 py-2 sm:px-4 sm:py-3 dark:bg-zinc-900">
        <div className="flex sm:flex-row sm:justify-between sm:items-center gap-2">
          ...
          <h1 className="text-xl sm:text-2xl font-semibold my-2 sm:my-3 text-zinc-100">Personal Details</h1>
        </div>
        ...
        <div className="relative my-4 sm:my-5">
          ...
          <div className="my-2 col-span-2">
            <p className="m-2 text-xs sm:text-sm">LeetCode Profile (Optional)</p>
            <input
              onChange={handleChange}
