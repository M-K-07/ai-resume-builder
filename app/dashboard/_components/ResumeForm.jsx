          ...
          <div className="flex gap-3">
            {!isFreshResume && (
              <button
                ...
                className="relative inline-flex h-10 overflow-hidden rounded-xl p-[1px] focus:outline-none hover:scale-105 active:scale-95 transition-all duration-300 ease-in-out disabled:opacity-50 disabled:hover:scale-100 cursor-pointer shadow-[0_0_15px_rgba(168,85,247,0.25)] hover:shadow-[0_0_22px_rgba(168,85,247,0.45)]"
              >
                ...
                <span className="inline-flex h-full w-full items-center justify-center gap-2 rounded-xl bg-zinc-950/90 px-4 py-2 text-xs md:text-sm font-semibold text-zinc-100 backdrop-blur-xl group hover:bg-zinc-900 transition-colors">
                  <Sparkles size={14} className="text-purple-400 animate-pulse group-hover:text-purple-300" />
